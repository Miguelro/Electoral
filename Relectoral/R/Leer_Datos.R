...
#'
#'@examples
#'c<-Agregado_Mun_MIR(1989,"06",Tipo = "Europeas","G :/")
#'
#'
#'@export
Agregado_Mun_MIR<-function(Ano,Mes,Tipo,Ruta,Borrar=T){
  out<-tryCatch({
    ...
    warning = function(cond){
      message("Se ha generado un warning, puede que no exista la ruta  o no se puede escribir en ella")
      message("El mensaje de warning es el siguiente:")
      message(cond)
      return(NULL)
    },
    error= function(cond){
      message("La ruta facilitada no existe o no se puede escribir en ella")
      message("El mensaje de error es el siguiente:")
      message(cond)
      return(NA)
    }
...
#'@examples
#'
#'c2<-Desagregados_Mesa_Mir(2019,"04",Tipo = "Congreso", Ruta = "D:/",Borrar = T)
#'
#'
#'@export
Desagregados_Mesa_Mir<-function(Ano,Mes,Tipo,Ruta,Borrar=T ){
  ...
  message("Generando fichero dat01")
  ...
  message("Generando fichero dat02")
  ...
  message("Generando fichero dat03")
  ...
  message("Generando fichero dat04")
  ...
  message("Generando fichero dat05")
  ...
  message("Generando fichero dat06")
  ...
  message("Generando fichero dat07")
  ...
  message("Generando fichero dat08")
  ...
  message("Generando fichero dat09")
  ...
  message("Generando fichero dat10 (tarda un poco)")
