...
#'@seealso \code{\url{https://en.wikipedia.org/wiki/Largest_remainder_method}} en wikipedia
#'
#'
#'
...
#'@seealso \code{\url{https://en.wikipedia.org/wiki/D\%27Hondt_method}} en wikipedia
#'
#'
