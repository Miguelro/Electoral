...
#'página web \code{\url{https://www.bochsler.eu/pns/}}. El fichero excel que se puede desccargar
#'contiene una macro para clacular \bold{el índice de nacionalización de partidos}, muy
...
#'\code{\url{http://www.infoelectoral.mir.es/}}. Estos datos así creados están dispuestos de
...
#' La descarga del programa se puede hacer en \code{\url{https://www.math.uni-augsburg.de/htdocs/emeriti/pukelsheim/bazi/}}
#' Instrucciones sobre su uso se pueden en contrar en la siguiente dirección web:
#' \code{\url{https://opus.bibliothek.uni-augsburg.de/opus4/frontdoor/index/index/docId/601}}.
